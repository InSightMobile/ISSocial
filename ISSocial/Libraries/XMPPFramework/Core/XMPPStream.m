...
- (void)commonInit {
    ...
    multicastDelegate = (GCDMulticastDelegate < XMPPStreamDelegate > *)
...
- (void)sendIQ:(XMPPIQ *)iq withTag:(long)tag {
    ...
    if (![multicastDelegate hasDelegateThatRespondsToSelector:selector]) {
        ...
        dispatch_async(willSendIqQueue, ^{
            @autoreleasepool {
...
- (void)sendMessage:(XMPPMessage *)message withTag:(long)tag {
    ...
    if (![multicastDelegate hasDelegateThatRespondsToSelector:selector]) {
        ...
        dispatch_async(willSendMessageQueue, ^{
            @autoreleasepool {
...
- (void)sendPresence:(XMPPPresence *)presence withTag:(long)tag {
    ...
    if (![multicastDelegate hasDelegateThatRespondsToSelector:selector]) {
        ...
        dispatch_async(willSendPresenceQueue, ^{
            @autoreleasepool {
...
- (void)receiveIQ:(XMPPIQ *)iq {
    ...
    if (![multicastDelegate hasDelegateThatRespondsToSelector:selector]) {
        ...
        dispatch_async(willReceiveIqQueue, ^{
            @autoreleasepool {
...
- (void)receiveMessage:(XMPPMessage *)message {
    ...
    if (![multicastDelegate hasDelegateThatRespondsToSelector:selector]) {
        ...
        dispatch_async(willReceiveMessageQueue, ^{
            @autoreleasepool {
...
- (void)continueReceiveIQ:(XMPPIQ *)iq {
    if ([iq requiresResponse]) {
        ...
        dispatch_async(didReceiveIqQueue, ^{
            @autoreleasepool {
